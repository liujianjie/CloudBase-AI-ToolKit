...
1. **Follow the workflow strictly**
   ...
   - Use available clarification or confirmation mechanisms when needed
...
1. If you determine that the user's input is a new requirement, you can work independently following standard software engineering practices. Confirm with the user when necessary.
