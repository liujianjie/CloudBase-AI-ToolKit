...
- `queryFunctions` - Query functions, logs, layers, triggers, and download URLs
- `manageFunctions` - Create/update/invoke functions and manage triggers and layers
...
- `manageGateway(action="createAccess")` - Create HTTP access for a supported target such as a function
