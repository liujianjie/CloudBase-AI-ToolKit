...
| database | `readNoSqlDatabaseStructure`, `writeNoSqlDatabaseStructure`, `readNoSqlDatabaseContent`, `writeNoSqlDatabaseContent`, `executeReadOnlySQL`, `executeWriteSQL`, `manageDataModel`, `createDataModel` |
