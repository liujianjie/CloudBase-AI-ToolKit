...
特别说明：
- rules 模板会自动包含当前 mcp 版本号信息（版本号：2.9.0），便于后续维护和版本追踪
...
文档名：auth-web 文档介绍：CloudBase Auth v3 Web SDK - Quick Reference Guide
