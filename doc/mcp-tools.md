...
特别说明：
- rules 模板会自动包含当前 mcp 版本号信息（版本号：2.16.1-beta.1），便于后续维护和版本追踪
...
<thead><tr><th>参数名</th><th>类型</th><th>必填</th><th>说明</th></tr></thead>
<tbody>
<tr><td><code>action</code></td><td>string</td><td>是</td><td>可填写的值: "updateLoginConfig", "updateProvider", "updateClientConfig", "createApiKeyToken", "createCustomLoginKeys"</td></tr>
<tr><td><code>loginConfig</code></td><td>object</td><td></td><td>updateLoginConfig 使用的登录配置对象</td></tr>
<tr><td><code>providerId</code></td><td>string</td><td></td><td>provider 标识，如 email、google</td></tr>
