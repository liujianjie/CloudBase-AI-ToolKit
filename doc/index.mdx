...
> **建议**：如果你是第一次使用，先从下方图标进入对应 IDE 的接入文档；完成 MCP 连接后，再继续安装 Skills 或使用下方提示词。
...
> 如果你还没完成 MCP 连接，建议先回到上一步，根据所用 IDE 的接入文档完成配置。
...
详见 [如何使用 Skill](/ai/cloudbase-ai-toolkit/skills/how-to-use)。
